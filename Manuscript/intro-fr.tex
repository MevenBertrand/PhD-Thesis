...
Le projet \kl{MetaCoq}, a pour but de répondre à cette problématique.
...
Une fois ces propriétés établies, la deuxième étape consiste à programmer un algorithme de vérification de type ressemblant au maximum à celui du noyau, directement en Gallina,\sidenote{
  En effet, grâce à la \kl{correspondance de Curry-Howard}, Gallina est certes un langage pour décrire des preuves, mais aussi un véritable langage de programmation fonctionnel !}
...
Comme le cas de \kl{MetaCoq} l’illustre, Coq peut être utilisé comme un véritable langage
...
programmation : le typage graduel. Ici encore, la \kl{correspondance de Curry-Howard}
...
Dans l’approche statique\sidenote{Qui est celle sur laquelle est basée Coq.},
...
Pourquoi choisir ? Le programme de recherche du \kl{typage graduel} \sidecite{Siek2015} vise à dépasser ce dilemme, en intégrant dans un même langage disciplines statiques et dynamiques.
...
% La littérature sur ce sujet est relativement confidentielle :
% la première présentation explicite de cette approche
% est probablement \sidecite{Pierce2000},
% et il faut attendre \sidecite{Dunfield2021} pour une étude plus globale de la
% question.
