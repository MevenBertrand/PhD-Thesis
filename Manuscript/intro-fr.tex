...
Et comme tout développement logiciel, le \kl{noyau} n’est pas à l’abri de bugs\sidenote{De l’ordre d'un bug détecté par an, une liste est maintenue à l’adresse suivante : \url{https://github.com/coq/coq/blob/master/dev/doc/critical-bugs}.}.
...
formalisation se basant sur \kl{MetaCoq}, ce qui a donné lieu à une seconde publication
