...
De tels outils sont appelés \kl{assistants à la preuve}, et il sera dans cette thèse
...
\citetitle{Begriffsschrift}, mais de plus construit dans ce système une quantité importante
...
preuve est un sujet de recherche actif \sidecite{Boehme2010,Ekici2017}.
...
et la tendance à la complexification du \kl{noyau} ne risque pas de s’arrêter de si tôt.
...
On démontre en même temps qu’il est bien \reintro{correct} –
  si l’algorithme prétend qu’un terme est bien typé, alors c’est bien le cas –
et \reintro{complet} – l’algorithme répond bien affirmativement sur tous les termes bien typés.
Enfin, une troisième étape extrait
un autre programme plus efficace de ce programme \kl{Gallina} certifié.
Cette efficacité est cruciale si on veut l’utiliser en lieu et place du \kl{noyau} actuel.
