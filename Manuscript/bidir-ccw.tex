...
\end{itemize}
We also use \intro{well-typed} for a term, with the same meaning as \kl{well-formed}.
...
\begin{theorem}[\intro(bidir){Correctness} of bidirectional typing for \kl{CCω}]
...
\begin{theorem}[\intro(bidir){Completeness} of bidirectional typing for \kl{CCω}]
...
But this is pretty much the content of \kl{standardization}.
