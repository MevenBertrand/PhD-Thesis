...
\sidenote{Expressed by the \pcuicline{OnFreeVars}{is\_open\_term}{253} predicate.}
...
entry in the \kl{environment} – this is the
\pcuicline{EnvironmentTyping}{consistent\_instance\_ext}{154} predicate.
