...
\sidecite[][Annex~A]{Girard1972} shows how having a type with itself as type is inconsistent.
This inconsistency directly applies to the first dependent type system proposed by Martin-Löf 
\sidecite{MartinLoef1972}, which had a single universe $\uni$ and a rule $\uni : \uni$.
