...
\begin{figure}[h]
  \ContinuedFloat
  \begin{mathpar}
    \inferdef{Refl}{ }{\Gamma \vdash t \udconv t}
    \label{rule:cic-uconv-refl} \and
    \inferdef{Sym}{\Gamma \vdash t \udconv t'}{\Gamma \vdash t' \udconv t}
    \label{rule:cic-uconv-sym} \and
    \inferdef{Trans}
      {\Gamma \vdash t \udconv t' \\ \Gamma \vdash t' \udconv t''}
      {\Gamma \vdash t \udconv t''}
