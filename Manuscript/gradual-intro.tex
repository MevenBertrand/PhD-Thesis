...
Tabareau on the subject to gradualize \kl{CIC} \sidetextcite{LennonBertrand2022}.
...
the properties one should demand of such a type system. It ends with a proposed solution
to those challenges, the \kl{Gradual Calculus of Inductive Constructions} (\kl{GCIC}).
...
This represents my main technical contribution to \textcite{LennonBertrand2022}.
Finally, \cref{chap:beyond-gcic} gives an overview of the rest of our work in the area:
a model used to establish properties of the target language of the elaboration procedure,
