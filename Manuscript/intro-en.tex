...
independently of its content. Indeed, the whole focus of logic as a discipline from that
...
At that time already, logic was conceived as a means towards communication.
...
The main challenge of logic is thus to construct such a formal system, adapted to a specific
...
Even though the links between logic and mathematics go back to Greek Antiquity,
...
century, the research in mathematical logic came to a globally satisfying situation.
