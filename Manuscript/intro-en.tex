...
at the crossroads between computer science and mathematical logic.
...
main questions of the field. Follows a presentation of the links between logic and
...
\sidenote{
  That is, it is possible to use it to prove falsity, and, from it, all propositions,
  making the logical system collapse – this is known as the principle of explosion.
  It thus cannot serve as an adequate foundation for mathematics.
} !
...
Moreover, proof \emph{assistant} are not simple proof checkers: beyond simple verification,
...
\sidenote{Made explicit for the first time in informal notes by Howard in 1969,
published only much later \cite{Howard1980},
based upon previous remarks by Curry \cite{Curry1958}.}%
...
\sidenote{A definition of a type-checking algorithm proven correct but not complete by
Simon Boulier was already present, although I had to alter it slightly for the completeness
proof}
