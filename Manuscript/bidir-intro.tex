...
Following this decomposition – pioneered by \sidetextcite{Pierce2000} – leads to type
systems that are more structured and directly amenable to implementations,
...
This is appealing, but despite advocacy by \eg
...
even on terms not in normal forms. Indeed, reduction is only normalizing
...
reduction before knowing that it is well-typed, but might no be able to type-check it
